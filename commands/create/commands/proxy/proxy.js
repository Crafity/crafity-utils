...
module.exports = function CreateProxyCommand(args, commands) {
  ...
  this.execute = function execute() {
    ...
    childProcess.exec(commandPath + 'proxy.sh ' + projectName + " " + targetDir, { cwd: commandPath }, function (error, stdout, stderr) {
      if (error) {
